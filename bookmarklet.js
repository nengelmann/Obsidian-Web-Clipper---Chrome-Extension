(function(){javascript: Promise.all([import('https://unpkg.com/turndown@6.0.0?module'), import('https://unpkg.com/@tehshrike/readability@0.2.0'), ]).then(async ([{
    default: Turndown
}, {
    default: Readability
}]) => {
  ...
  const fileContent = 
   ...
   document.location.href = "obsidian://new?"
    + "file=" + encodeURIComponent(folder + today + '_' + fileName)
